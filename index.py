...
my_file = open("C:\\Users\\user\\Downloads\\yolov8\\utils\\coco.txt", "r")
data = my_file.read()
...
model6 = YOLO("C:\\Users\\user\\Downloads\\yolov8\\weights\\model6.pt", "v8")
model7 = YOLO("C:\\Users\\user\\Downloads\\yolov8\\weights\\model7.pt", "v8")
damagemodel = YOLO(
    "C:\\Users\\user\\Downloads\\yolov8\\weights\\damaged_detect.pt", "v8"
)
frame_wid = 640
frame_hyt = 480

key_path = r"C:\Users\user\Downloads\teamproject-416403-41cdf314768a.json"
